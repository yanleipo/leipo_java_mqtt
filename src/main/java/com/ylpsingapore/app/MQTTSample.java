...
public class MQTTSample implements MqttCallback {
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			MQTTSample sampleClient = new MQTTSample(url, clientId, cleanSession, quietMode,userName,password);
   ...
   * @param password the password for the user
	 ...
	 */
    public MQTTSample(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
